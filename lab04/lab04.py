def divide(quotients, divisors):
    ...
    """
    return {q : [d for d in divisors if 0 == d % q] for q in quotients}
...
def buy(fruits_to_buy, prices, total_amount):
    ...
    def add(fruits, amount, cart):
        if fruits == [] and amount == 0:
            ...
            fruit = fruits[0]
            price = prices[fruit]
            for k in range(1, amount // price + 1, 1): # [1, 2, 3, ..., amount // price], at least 1 per kind of fruit
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    distance_a = distance(city_a, make_city('temp', lat, lon))
    distance_b = distance(city_b, make_city('temp', lat, lon))
